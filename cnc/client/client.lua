...
AddEventHandler("CNC:setDensity", function(PedDensity, TrafficDensity)
    ...
    Citizen.Trace('SetDensity: Ped:'..tostring(PedDensity) .. ' - Traffic:'.. tostring(TrafficDensity))
end)
